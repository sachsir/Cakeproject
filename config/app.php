...
return [
     ...
     */
    'Security' => [
        'salt' => env('SECURITY_SALT','jhgjgbccccccccccccccccccccccccccccccccccccccccccccdfgdfgg'),
    ],
    ...
    'EmailTransport' => [
        'default' => [
            ...
            'gmail' => [
                'host' => 'smtp.gmail.com',
                'port' => 587,
                'username' => 'sachinsingh10101997@gmail.com', //eg: sample[at]gmail.com
                'password' => 'yelizdipjxwfechw', //email password
                'className' => 'Smtp',
                'tls' => true,
                'client' => null,
                'url' => env('EMAIL_TRANSPORT_DEFAULT_URL', null),
